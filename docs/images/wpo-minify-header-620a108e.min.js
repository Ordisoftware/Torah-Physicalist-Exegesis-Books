...
fn()})}}
this.initialise=function(){if(shield_vars_antibotjs.flags.run){sendReq()}
domReady(function(){})};var fire=function(){var sendRequest=!1;var current=getCookie('icwp-wpsf-notbot');if(current===undefined){sendRequest=!0}else{var remaining=current.split("z")[0]-Math.floor(Date.now()/1000);if(remaining<60){sendRequest=!0}}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://asherhaimhalevi.ordisoftware.com/wp-content/plugins/wp-simple-firewall/resources/js/shield/antibot.js\n- Error message: "+ e.message);}
